let funcs;_cbc‍.w("./matrices.js",[["funcs",["funcs"],function(v){funcs=v}]]);
...
//console.log(layers);
_cbc‍.g.console.log(layers.l1.W);
_cbc‍.g.console.log(funcs.matrix_multiply(layers.l1.W,(funcs.newmatrix([[1.1], [1.2]]))));
