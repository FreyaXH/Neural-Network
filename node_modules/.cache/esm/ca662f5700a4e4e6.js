_00a‍.x([["creatematrix",()=>creatematrix],["transpose",()=>transpose],["dot",()=>dot],["add",()=>add]]);function creatematrix(a) { //create matrix object with rows and cols properties.
    const matrix = {
...
{
    const newarr2 = transpose(arr2);
    if(ar2_row >= newarr2.rows()){
